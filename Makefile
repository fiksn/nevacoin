#############################################################################
# Makefile for building: nevacoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sun Mar 6 10:29:09 2016
# Project:  nevacoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake USE_QRCODE=1 -o Makefile nevacoin-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DUSE_QRCODE -DUSE_UPNP=1 -DMINIUPNP_STATICLIB -DSTATICLIB -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -m64 -pipe -std=c99 -O2 -std=c99 -D_REENTRANT -Wall -W $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lqrencode -lminiupnpc /home/kristian/src/nevacoin/nevacoin_release/src/leveldb/libleveldb.a /home/kristian/src/nevacoin/nevacoin_release/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/kristian/src/nevacoin/nevacoin_release/src/leveldb/libleveldb.a /home/kristian/src/nevacoin/nevacoin_release/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_blockbrowser.h build/ui_optionsdialog.h build/ui_qrcodedialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: nevacoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) USE_QRCODE=1 -o Makefile nevacoin-qt.pro
...
/home/kristian/src/nevacoin/nevacoin_release/src/leveldb/libleveldb.a: FORCE
	cd /home/kristian/src/nevacoin/nevacoin_release/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/kristian/src/nevacoin/nevacoin_release/build/build.h: FORCE
	cd /home/kristian/src/nevacoin/nevacoin_release; /bin/sh share/genbuild.sh /home/kristian/src/nevacoin/nevacoin_release/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/nevacoin-32.png \
		...
		src/qt/res/icons/nevacoin-16.png \
		...
		src/qt/res/icons/nevacoin-80.png \
...
build/blake2s-ref.o: src/blake2s-ref.c src/blake2.h \
		src/blake2-impl.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o build/blake2s-ref.o src/blake2s-ref.c
